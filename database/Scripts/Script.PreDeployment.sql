...
*/
	...
	*/
	...
	/*
	--------------------------------------------------------
	2.PreDeployment.Settings.sql - START
	--------------------------------------------------------
	*/
		PRINT '		2.PreDeployment.Settings.sql - START'
		GO

		:r ..\ContinuousDeployment\2.PreDeployment.Settings.sql
		GO

		PRINT '		2.PreDeployment.Settings.sql - END'
		GO
	/*
	--------------------------------------------------------
	2.PreDeployment.Settings.sql - END
	--------------------------------------------------------
	*/
